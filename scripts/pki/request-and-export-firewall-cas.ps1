...
"@
    ...
    Write-Host ""
    Write-Host "  ✅ SUCCESS: $firewallName certificate ready for import" -ForegroundColor Green
    Write-Host ""
...
Write-Host "  3. Navigate to: Device → Certificate Management → Certificates" -ForegroundColor Yellow
