...
class PanOSSSLDecryptAutomation:
    ...
    def import_ca_certificate(self, cert_name, cert_path, key_path=None, passphrase=None, 
        ...
        try:
            ...
            if cert_format == 'pem':
                ...
                logger.info(f"✓ PKCS12 certificate '{cert_name}' imported")
                return True
    ...
    def configure_ssl_decryption_profile(self, profile_name='BSL-SSL-Decrypt-Profile'):
        ...
        try:
            ...
            logger.info("✓ SSL Decryption profile configured (requires commit)")
        ...
        try:
            ...
            if cert_list_xml is not None:
                ...
                if cert_name in certs:
                    logger.info(f"✓ Certificate '{cert_name}' is installed")
                    return True
                else:
...
Examples:
  ...
  for fw in 192.168.0.7 192.168.255.200; do
    ...
    try:
        ...
        logger.info("")
        logger.info("═══════════════════════════════════════════")
        logger.info("  ✓ SSL DECRYPTION CA IMPORT COMPLETE")
        logger.info("═══════════════════════════════════════════")
