...
"""
        ...
        try:
            ...
            logger.info("   âœ… Certificate issued by step-ca")
            ...
            logger.info(f"   âœ… PFX created: {pfx_file}")
            
            return pfx_file, passphrase
            
        except subprocess.CalledProcessError as e:
            logger.error(f"   âŒ step-ca request failed: {e}")
    ...
    def configure_ssl_tls_profile(self, cert_name):
        ...
        try:
            ...
            logger.info("   âš ï¸  NOTE: Full profile configuration requires GUI or complete XML")
            ...
            logger.error(f"   âŒ Profile creation failed: {e}")
            return False
